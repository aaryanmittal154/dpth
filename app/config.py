...
class SearchSettings(BaseModel):
    ...
    country: str = Field(
        default="us",
        description="Country code for search results (e.g., us, ind, uk)",
    )
...
class SandboxSettings(BaseModel):
    type: str = Field("docker", description="Sandbox type (docker/local)")
    isolated_runtime_dir: Optional[Path] = Field(
        None, description="Directory for isolated runtime (for container mode)"
    )
...
class Config:
    ...
    def from_toml(cls, config_path: str) -> "Config":
        ...
        base_llm = raw_config.get("llm", {})
        llm_overrides = base_llm.get("override", {})
